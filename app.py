...
VIVID_HIGHLIGHT = "#38BDF8" # Xanh Neon - Đỉnh 13 khách, Engagement tốt
SILVER_DIM = "#94A3B8"      # Bạc Slate (Dim) - Màu nền cho các giá trị thấp/trung bình
AVG_HIGHLIGHT = "#BAE6FD"   # Xanh Nhẹ (Lighter Blue) - Cho Average Lines
...
<style>
    ...
    div[data-testid="metric-container"] {{
        ...
        border-left: 5px solid {VIVID_HIGHLIGHT}; 
    }}
...
with left_col:
    ...
    avg_clients = workload_counts.mean() 
...
# ==========================================
# 4. ENGAGEMENT PERFORMANCE (KÈM ĐƯỜNG TRUNG BÌNH)
# ==========================================
with right_col:
...
# ĐÂY LÀ DÒNG CODE CHIA CỘT BỊ MẤT ĐÃ ĐƯỢC KHÔI PHỤC
st.markdown("<br>", unsafe_allow_html=True)
...
# ==========================================
st.markdown("---")
st.markdown("## 🚀 Strategic Recommendations (Operational Focus)")
...
with i_col1:
    st.error(f"**🔴 RED ALERT: Financial Underperformance**\n\nOperational Issues Detected: The bottom coaches have a **0% Full Payment Rate**, falling far below the company average. This indicates serious contract collection leakage and requires an immediate audit.")
